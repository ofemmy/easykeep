      ...
      <div className="mt-1 flex sm:mt-0 sm:ml-4">
        ...
        {actionButtons.map((btn) => (
          <Link href="/new" key={btn}>
            <a className="hidden order-0 md:inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:order-1 sm:ml-3 flex-none ml-4">
              {btn}
            </a>
          </Link>
        ))}
