        ...
        <div className="px-2 space-y-1">
          {
            ...
            <Link href={`${AppMainLinks[linkItem].href}`}
            key={linkItem}
            >
              <a className={`group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-blue-100
                 hover:text-white hover:bg-gray-600 ${activeLink===linkItem?'bg-gray-600 text-white':''}`}
